package com.example.duanmau_luclhph12819.adapter;
...
import com.example.duanmau_luclhph12819.R;
import com.example.duanmau_luclhph12819.dao.NguoiDungDao;
import com.example.duanmau_luclhph12819.model.NguoiDung;

import java.util.List;

public class NguoiDung_Adapter extends BaseAdapter {
    List<NguoiDung> arrNguoiDung;
    public Activity context;
    public LayoutInflater inflater;
    NguoiDungDao nguoiDungDAO;
    public NguoiDung_Adapter(Activity context, List<NguoiDung> arrayNguoiDung) {
        super();
