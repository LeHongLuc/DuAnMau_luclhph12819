...
import com.example.duanmau_luclhph12819.adapter.HoaDonAdapter;
import com.example.duanmau_luclhph12819.dao.HoaDonDao;
import com.example.duanmau_luclhph12819.model.HoaDon;

import java.util.ArrayList;
import java.util.List;

public class List_HoaDon_Activiti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list__hoa_don__activiti);
        setTitle("HOÁ ĐƠN");
        lvHoaDon = (ListView) findViewById(R.id.lvHoaDon);
        hoaDonDAO = new HoaDonDao(List_HoaDon_Activiti.this);
        try {
        ...
        lvHoaDon.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(List_HoaDon_Activiti.this,
                        List_HDCT_Activity.class);
                Bundle b = new Bundle();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case R.id.themhoadon:
                Intent intent = new
                        Intent(List_HoaDon_Activiti.this,HoaDonActivity.class);
                startActivity(intent);
                return(true);
        }
